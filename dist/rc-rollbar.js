(function(angular) {
    "use strict";
    var module = angular.module("rcRollbar", []);
    module.config([ "$provide", function($provide) {
        $provide.decorator("$log", [ "$delegate", "$injector", "$window", function($delegate, $injector, $window) {
            function _bindRollbarMethod(method, msg) {
                $window.Rollbar[method](msg[0], function(err, data) {
                    var $rootScope = $injector.get("$rootScope");
                    $rootScope.$emit("rollbar:log:" + method, {
                        exception: method,
                        err: err,
                        data: data.result
                    });
            ...
            if ($window.Rollbar) {
                methods = {
                    ...
                    error: function() {
                        ...
                        if ($window.Rollbar.options.enableLogLevel.error === true) {
                            _bindRollbarMethod("error", arguments);
                        }
                    },
                    warn: function() {
                        $delegate.warn.apply($delegate, arguments);
                        if ($window.Rollbar.options.enableLogLevel.warning === true) {
                            _bindRollbarMethod("warning", arguments);
                        }
                    },
                    debug: function() {
                        $delegate.debug.apply($delegate, arguments);
                        if ($window.Rollbar.options.enableLogLevel.debug === true) {
                            _bindRollbarMethod("debug", arguments);
                        }
                    },
                    info: function() {
                        $delegate.info.apply($delegate, arguments);
                        if ($window.Rollbar.options.enableLogLevel.info === true) {
                            _bindRollbarMethod("info", arguments);
                        }
                    }
                };
            }
    ...
    module.provider("Rollbar", function RollbarProvider() {
        ...
        this.init = function(config) {
            if (angular.isUndefined(config.enableLogLevel) || !angular.isObject(config.enableLogLevel)) {
                config.enableLogLevel = {};
            }
            config.enableLogLevel = angular.extend(enableLogLevel, config.enableLogLevel);
            ...
            if (rollbarActivated) {
                !function(r) {
                    ...
                    "use strict";
                    var e = n(1), t = n(4);
                    _rollbarConfig = _rollbarConfig || {}, _rollbarConfig.rollbarJsUrl = _rollbarConfig.rollbarJsUrl || "https://cdnjs.cloudflare.com/ajax/libs/rollbar.js/2.1.0/rollbar.min.js", 
                    _rollbarConfig.async = void 0 === _rollbarConfig.async || _rollbarConfig.async;
                    var a = e.setupShim(window, _rollbarConfig), l = t(_rollbarConfig);
                    ...
                    function a(r, o) {
                        ...
                        var t = new d(o);
                        return e(function() {
                            return o.captureUncaught && (t._rollbarOldOnError = r.onerror, i.captureUncaughtExceptions(r, t, !0), 
                            i.wrapGlobals(r, t, !0)), o.captureUnhandledRejections && i.captureUnhandledRejections(r, t, !0), 
                            r[n] = t, t;
                        })();
                    }
                    function l(r) {
                        return e(function() {
                            var o = this, n = Array.prototype.slice.call(arguments, 0), e = {
                                shim: o,
                                method: r,
                                args: n,
                                ts: new Date()
                    ...
                    var i = n(2), s = 0, c = n(3), p = function(r, o) {
                        return new t(r, o);
                    }, d = c.bind(null, p);
                    t.prototype.loadFull = function(r, o, n, t, a) {
                        var l = function() {
                            ...
                            if (void 0 === r._rollbarDidLoad) {
                                ...
                                for (var n, e, t, l, i = 0; n = r._rollbarShims[i++]; ) for (n = n.messages || []; e = n.shift(); ) for (t = e.args || [], 
                                i = 0; i < t.length; ++i) if (l = t[i], "function" == typeof l) {
                                    l(o);
                                    break;
                                }
                            }
                            "function" == typeof a && a(o);
                        }, i = !1, s = o.createElement("script"), c = o.getElementsByTagName("script")[0], p = c.parentNode;
                        ...
                        try {
                            ...
                            if (!r._wrapped && (r._wrapped = function() {
                                try {
                                    ...
                                    var o = e;
                                    throw "string" == typeof o && (o = new String(o)), o._rollbarContext = n() || {}, 
                                    o._rollbarContext._wrappedSource = r.toString(), window._rollbarWrappedError = o, 
                                    o;
                                }
                            }, r._wrapped._isWrap = !0, r.hasOwnProperty)) for (var e in r) r.hasOwnProperty(e) && (r._wrapped[e] = r[e]);
                            return r._wrapped;
                        } catch (o) {
                            return r;
                        }
                    ...
                    function n(r, o, n) {
                        if (r) {
                            var t;
                            "function" == typeof o._rollbarOldOnError ? t = o._rollbarOldOnError : r.onerror && !r.onerror.belongsToShim && (t = r.onerror, 
                    ...
                    function e(r, o, n, e) {
                        r._rollbarWrappedError && (e[4] || (e[4] = r._rollbarWrappedError), e[5] || (e[5] = r._rollbarWrappedError._rollbarContext), 
                        r._rollbarWrappedError = null), o.handleUncaughtException.apply(o, e), n && n.apply(r, e);
                    }
                    function t(r, o, n) {
                        if (r) {
                            "function" == typeof r._rollbarURH && r._rollbarURH.belongsToShim && r.removeEventListener("unhandledrejection", r._rollbarURH);
                            var e = function(r) {
                                var n = r.reason, e = r.promise, t = r.detail;
        ...
        function getter($window) {
            ...
            function logInactiveMessage(method) {
            ...
            if (rollbarActivated) {
                ...
                service.enableLogLevel = enableLogLevel;
            }
            return service;
        }
...
//# sourceMappingURL=rc-rollbar.js.map
